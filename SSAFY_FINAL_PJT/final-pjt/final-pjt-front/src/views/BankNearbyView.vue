  ...
  <div class="full-height">
    <div class="map_wrap">
        ...
        <div id="menu_wrap" class="bg_white">
            <div class="option">
                <div>
                    <p><strong>근처 은행 검색</strong></p>
                    <form @submit.prevent="searchPlaces()">
                        키워드 : <input type="text" id="keyword" size="15" v-model="input_keyword"> 
...
function searchPlaces() {
    ...
    const keyword = input_keyword.value;
    if (keyword === '') { 
        input_keyword.value = ''
        return false;
    }
...
.full-height {
  height: 94.5vh; /* 화면 높이의 100%로 설정합니다. */
  display: flex; /* 내부 요소를 수직으로 정렬하기 위해 Flexbox를 사용합니다. */
  justify-content: center; /* 가로 중앙 정렬합니다. */
